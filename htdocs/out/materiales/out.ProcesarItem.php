...
//devuelve el id del item recien creado
 function crearItem($nombreItem,$descripcion,$empresa,$costo,$costoCompra,$origen,$cantidadInicial,$dms)
	 {
	 	$res=true;
		$db = $dms->getDB();
		$insertar = "INSERT INTO app_item VALUES(NULL,'$nombreItem','$descripcion','$empresa',$costo,$costoCompra,'$origen','$cantidadInicial','$cantidadInicial')";
...
////////hago metida en BD
$idCreado=crearItem($nombreItem,$descripcion,$empresa,$costo,$costoCompra,$origen,$cantidadInicial,$dms);
