...
class SeedDMS_View_PaginaPrincipal extends SeedDMS_Bootstrap_Style {
	...
	////////////// AQUI VA MI CONTENIDO DE ENAFOP		
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>Control de materiales divulgativos entregados</h3>
            ...
            <a href="out.ViewFolder.php" class="small-box-footer">Acceder<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>Confirmaciones a eventos y convocatorias ENAFOP</h3>

              <p> vía formulario web</p>
            </div>
            <div class="icon">
