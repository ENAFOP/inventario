...
class SeedDMS_View_VerUbicaciones extends SeedDMS_Bootstrap_Style 
{
 /**
 ...
 **/
	...
	{ /* {{{ */
        ...
        <li class="active">Ver ubicaciones</li>
      </ol>
 ...
 $this->startBoxPrimary("Listado de bodegas y lugares de almacenamiento de los artículos");
$this->contentContainerStart();
//////INICIO MI CODIGO
?>
 <div class="box">
            <div class="box-header">
              <h3 class="box-title">Haga clic en el nombre de la ubicación para verla y editarla</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table id="tablaEventos" class="table table-hover table-striped table-condensed">
               ...
               <tbody>
                	...
                	//////////////// DIBUJO TABLA
                	$consultar = "SELECT * FROM app_ubicacion;";
					//echo "Consultar: ".$consultar;
				  	$res1 = $db->getResultArray($consultar);
                	for($cont=0;$cont<$numEventos;$cont++)
                	{
                		...
                		//1. nombre
                    $idItem=$res1[$cont]['id'];
                		 echo "<td><a href=\"/out/out.VerUbicacion.php?id=".$idItem."\">".$res1[$cont]['nombre']."</a></td>";
                		 //2. Descripción
