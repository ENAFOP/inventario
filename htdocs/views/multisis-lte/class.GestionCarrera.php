...
class SeedDMS_View_GestionCarrera extends SeedDMS_Bootstrap_Style {
	...
	function show() { /* {{{ */
		...
		echo "<div class=\"row\">";
		echo "<h3>Bienvenid@ al subsistema de gestión de carrera de  la Dirección de Formación en Tecnología y Gestión Pública!</h3>";
	...
	////////////// AQUI VA MI CONTENIDO DE ENAFOP		
        ...
        <!-- ./col -->
         <div class="col-lg-3 col-xs-3">
         		 <img src="../images/togaenafop.png" alt="Carrera ENAFOP"  class="img-fluid" alt="Responsive image">
        ...
        <div class="col-lg-6 col-xs-3">
          ...
          <div class="small-box bg-maroon">
            <div class="inner">
              <h3>HERRAMIENTA</h3>
              <p>de Gestión de Becas CLAD</p>
            </div>
            <div class="icon">
              <i class="fa  fa-male"></i>
            </div>
            <a href="carrera/out.PanelCLAD.php" class="small-box-footer">Acceder<i class="fa fa-arrow-circle-right"></i></a>
          </div>
