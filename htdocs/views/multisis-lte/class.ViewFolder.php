	...
	////////////// AQUI VA MI CONTENIDO DE ENAFOP		
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="out.GestionCarrera.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
      ...
      <div class="row">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Personas formadas</span>
              ...
              <span class="progress-description">
                    Procesos formativos desde 2018
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
